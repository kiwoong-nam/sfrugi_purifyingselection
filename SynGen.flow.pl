...
my $outF='/home/kiwoong/Projects/sfrugi_purifyingselection/SynGen/inv_100kb.m2.txt';
my $WS=100000;

my ($Hfs_share,$Hfs_nonshare)=colI("$inD/Native/frameshift.m2.vcf.gz","$inD/Invasive/frameshift.vcf.gz");
my ($Hsyn_share,$Hsyn_nonshare)=colI("$inD/Native/synonymous.m2.vcf.gz","$inD/Invasive/synonymous.vcf.gz");
