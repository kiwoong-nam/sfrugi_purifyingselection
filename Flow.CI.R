vi=read.table("/home/kiwoong/Projects/sfrugi_purifyingselection/Flow/inv_100kb.txt",h=T,sep="\t")

ot="/home/kiwoong/Projects/sfrugi_purifyingselection/Flow/inv.cts"
