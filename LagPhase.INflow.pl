...
my $outF='/home/kiwoong/Projects/sfrugi_purifyingselection/LagPhase/inv_100kb.India.txt';
my $WS=100000;

my ($Hfs_share,$Hfs_nonshare)=colI("$inD/Native/frameshift.vcf.gz","$inD/India/frameshift.vcf.gz");
my ($Hsyn_share,$Hsyn_nonshare)=colI("$inD/Native/synonymous.vcf.gz","$inD/India/synonymous.vcf.gz");
