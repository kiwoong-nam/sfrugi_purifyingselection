...
my $outF='/home/kiwoong/Projects/sfrugi_purifyingselection/Flow/inv_100kb.txt';
my $WS=100000;

my ($Hfs_share,$Hfs_nonshare)=colI("$inD/Native/frameshift.vcf.gz","$inD/Invasive/frameshift.vcf.gz");
my ($Hsyn_share,$Hsyn_nonshare)=colI("$inD/Native/synonymous.vcf.gz","$inD/Invasive/synonymous.vcf.gz");
